...
<head>
	<meta charset="UTF-8">
	<title>Estado | Gestión</title>
	<meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
	<link rel="stylesheet" href="{{asset('css/bootstrap.min.css')}}">
	<link rel="stylesheet" href="{{asset('css/styleestado.css')}}">
</head>
<body>
	<header>
		...
		<div class="container-fluid">
			<div class="row contenedor">
				<div class="col-md-6 col-md-offset-3 off">
					<form method="POST">
						<h2>Gestión de Estado</h2><br>
						{{ csrf_field() }}
						<div class="form-group">
							<label for="nombre">Nombre:</label>
							<input type="text" class="form-control" id="nombre" placeholder="nombre" name="nombre" value="{{$estado->nombreestado}}">
						</div>

						<button type="sudmir" class="btn btn-primary">Modificar</button>						
					</form>
				</div>
			</div>
		</div>
