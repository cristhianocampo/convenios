...
<head>
	<meta charset="UTF-8">
	<title>Cargo | Gestión</title>
	<meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
	<link rel="stylesheet" href="{{asset('css/bootstrap.min.css')}}">
	<link rel="stylesheet" href="{{asset('css/stylecargo.css')}}">
</head>
<body>
	<header>
		...
		<div class="container-fluid">
			<div class="row contenedor">
				<div class="col-md-6 col-md-offset-3 off">
					<form method="POST">
					{{ csrf_field() }}
						<h2>Gestión de Cargo</h2><br>
						<div class="form-group">
							<label for="nombre">Nombre:</label>
							<input type="text" class="form-control" id="nombre" placeholder="nombre" name="nombre" value="{{$cargo->cargo}}">
						</div>
