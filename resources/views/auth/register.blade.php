...
<div class="container-fluid">
    ...
    <section class="row main">
        <div class="col-md-6 col-md-offset-3 color">
            <form class="" role="form" method="POST" action="{{ url('usuario/registrar') }}">
            {{ csrf_field() }}
            ...
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                ...
                <input id="name" type="text" class="form-control text input-md" name="name" value="{{ old('name') }}">
                @if ($errors->has('name'))
            ...
            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                ...
                <input id="email" type="email" class="form-control text input-md" name="email" value="{{ old('email') }}">
                @if ($errors->has('email'))
                    <span class="help-block">
            ...
            <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                ...
                <input id="password" type="password" class="form-control text input-md" name="password">
            ...
            <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                ...
                <input id="password-confirm" type="password" class="form-control text input-md" name="password_confirmation">
