...
<body>
	...
	<div class="container-fluid">
		<section class="row gestion">
			<div class="container">
				<h3 class="titulo">Listado de Cargos</h3>
			</div>
		...
		<section class="row main">
			...
			<div class="row martop">
					...
					<br>
						<form class="form-inline" role="search" method="get" action="{{url('/cargo/busqueda')}}">
							{{ csrf_field() }}
				...
				<br>
					<div class="table-responsive">
						<table class="table table-bordered table-hover table-condensed">
							...
							<tr>
							@foreach($cargo as $worker)
                            <tr >
                                <td><a href="{{asset("cargo/$worker[idcargo]/editar")}}">{{$worker['cargo']}}</a></td>                       
                            </tr>
                            @endforeach						
							</tr>
						</table>
