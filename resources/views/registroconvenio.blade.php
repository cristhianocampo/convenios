...
<head>
	<meta charset="UTF-8">
	<title>Convenio | Registrar</title>
...
<body>
	...
	<div class="row main">
		<div class="col-md-10 col-md-offset-1 color">
			...
			<form method="POST" accept-charset="UTF-8" enctype="multipart/form-data" action={{url('/convenio/registrar')}}>
			{{ csrf_field() }}
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						<label for="idinstitucion">Intitucion</label>
						<select class="form-control" name="idinstitucion" required>
							<option value="" disable selected>Seleccione</option>
					...
					<div class="form-group">
						...
						<textarea class="form-control" name="objetivo" placeholder="Objetivo" required></textarea>
					</div>

					<div class="form-group">
						<label for="comentarios">Comentarios</label>
						<textarea class="form-control" name="comentarios" placeholder="Comentario" required></textarea>
					</div>
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						<label for="periodo">Fecha de firma del convenio</label>
						<input type="date" class="form-control" name="fechafirma" placeholder="Periodo" required>
					</div>

					<div class="col-md-6 uno">
						<div class="form-group">
							<label for="fecha">Período de vigencia</label>	
							<input type="date" class="form-control" name="fechainicio" required>
						</div>
					</div>

					<div class="col-md-6 una">
						<div class="form-group">
							<label for="fecha" style="color: white;">.</label>
					...
					<div class="form-group">
						...
						<textarea class="form-control des" name="descripcion" placeholder="Descripción" required></textarea>
					</div>
				</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1 color">
			<h3 class="title">Datos adicionales</h3>
				...
				<div class="col-md-6">
					<div class="form-group">
						<label for="gestor">Persona de enlace interna</label>
						<select class="form-control" name="gestor" required>
							<option value="" disable selected>Seleccione</option>
							@foreach($enlacei as $enla)
							<option value="{{$enla->idenlace}}">{{$enla->nombreenlace}}</option>
							@endforeach
						</select>
					</div>

					<div class="form-group">
						<label for="gestor">Persona de enlace externa</label>
						<select class="form-control" name="gestorext" required>
							<option value="" disable selected>Seleccione</option>
							@foreach($enlacee as $enlae)
							<option value="{{$enlae->nombreenlace}}">{{$enlae->nombreenlace}}</option>
							@endforeach
						</select>
					</div>

					<div class="form-group">
						<label for="gestor">Beneficio a corto plazo</label>
						<textarea class="form-control des" name="bcp" placeholder="Descripción" required></textarea>
					</div>
					<br>

					<div class="form-group">
						<h4 class="title">Archivo del convenio</h4>
						<input class= "sborde" type="file" id="exampleInputFile" name="file" required>
					    <p class="help-block">Menos de 300MB.</p>
					</div><br>
				...
				<div class="col-md-6">
					...
					<div class="form-group" style="margin-top: 90px;">
						<label for="gestor">Beneficio a largo plazo</label>
						<textarea class="form-control des" name="blp" placeholder="Descripción" required></textarea>
					</div>
				</div>				
			</form>
		</div>
