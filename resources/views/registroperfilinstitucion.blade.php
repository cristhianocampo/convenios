...
<head>
	<meta charset="UTF-8">
	<title>Institución | Registrar</title>
		...
		<div class="container-fluid">
			<div class="row contenedor">
				<div class="col-md-6 col-md-offset-3 off">
					<form method="post">					
						<h2>Registro de perfil de institución</h2><br>
						{{ csrf_field() }}
						...
						<div class="form-group">
							<label for="año">Año de Existencia:</label>
							<input type="text" class="form-control" id="nombre" placeholder="Año Existencia" name="año" name="año" required>
						</div>
						<div class="form-group">
							<label for="evaluacion">Evaluación de la Planta Física:</label>
							<textarea class="form-control" name="evaluacion" required></textarea>
						</div>

						<div class="form-group">
							<label for="numest">Numero de Estudiante:</label>
							<input type="text" class="form-control" placeholder="Numero de Estudiante" name="numest" required>
						</div>

						<div class="form-group">
							<label for="numdoce">Numero de Docentes:</label>
							<input type="text" class="form-control" placeholder="Numero de Docente" name="numdoce" required>
						</div>

						<div class="form-group">
							<label for="carre">Carreras que Ofrece:</label>
							<textarea class="form-control" placeholder="Carreras" name="carrera" required></textarea>
						</div>
