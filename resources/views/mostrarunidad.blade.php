...
<body>
	...
	<div class="container-fluid">
		<section class="row gestion">
			<div class="container">
				<h3 class="titulo">Listado de Unidad</h3>
			</div>
		...
		<section class="row main">
			...
			<div class="row martop">
					...
					<br>
						<form class="form-inline" role="search" method="get" action="{{url('/unidad/busqueda')}}">
							{{ csrf_field() }}
				...
				<br>
					<div class="table-responsive">
						<table class="table table-bordered table-hover table-condensed">
							...
							@foreach($unidad as $worker)
                            <tr >
                                <td><a href="{{asset("unidad/$worker[idunidad]/editar")}}">{{$worker['nombreunidad']}}</a></td>                          
                            </tr>
                            @endforeach	
						</table>
					</div>
